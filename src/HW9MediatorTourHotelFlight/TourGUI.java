package HW9MediatorTourHotelFlight;
...
public class TourGUI extends JFrame implements ParticipantGUI{
  ...
  private static File cusFile = new File("TourCustomer.xml");
  private static File possibleCusFile = new File("TourPossibleCustomer.xml");


  public TourGUI(BusinessMediator bMdtr) {
     super("Mediator Pattern- Tour ");
     bMediator = bMdtr;
     setUpChoicePanel();
     setUpScrollPanes();
