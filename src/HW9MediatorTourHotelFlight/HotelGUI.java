...
public class HotelGUI extends JFrame implements ParticipantGUI {
  ...
  private static File cusFile = new File("HotelCustomer.xml");
  private static File possibleCusFile = new File("HotelPossibleCustomer.xml");
